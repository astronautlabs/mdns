...
Advertisement.prototype._makeAddressRecords = function (addresses) {
  ...
  var As = addresses.filter(function (_ref3) {
    ...
    return new ResourceRecord.A({ name: name, address: address, ttl: _this8.hostTTL  });
  });
  ...
  var AAAAs = addresses.filter(function (_ref5) {
    ...
    return new ResourceRecord.AAAA({ name: name, address: address, ttl: _this8.hostTTL  });
  });
