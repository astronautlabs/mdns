...
class RecordCollection {
   ...
   */
  equals(values) {
    const otherSet = values instanceof RecordCollection ? values : new RecordCollection(values);
   ...
   */
  getConflicts(values) {
    let otherSet = values instanceof RecordCollection ? values : new RecordCollection(values);
    ...
    const conflicts = otherSet.filter(otherRecord => thisSet.some(thisRecord => thisRecord.conflictsWith(otherRecord)));
