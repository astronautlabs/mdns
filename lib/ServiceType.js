...
class ServiceType {
  ...
  _validate() {
    if (typeof this.name !== 'string') {
      throw new ValidationError('Service name must be a string, got %s', typeof this.name);
    }
    ...
    if (typeof this.protocol !== 'string') {
      throw new ValidationError('Protocol must be a string, got %s', typeof this.protocol);
    }
